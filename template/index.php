...
<body data-page="<?php echo $page; ?>">
    ...
    <?php include($tpl_setting['Template']::__dir('module/loading/loading01.php'));?>
    ...
    <?php if(0):?>
        <?php include($tpl_setting['Template']::__dir('module/banner/banner'.$tpl_setting['banner'].'.php'));?>
    <?php endif?>

    <div class="index_wrap">
        <?php include($tpl_setting['Template']::__dir('view/home/home.php'));?>
    </div>
